...
import { MessageSquare, X, Hash, Layers } from 'lucide-react';
...
export function ThreadsPanel({
  ...
  // Clicking a thread that is already selected deselects it (shows all messages).
  // Clicking a different thread selects it.
  const handleThreadClick = useCallback(
    (threadId: number) => {
      onThreadSelect(selectedThreadId === threadId ? null : threadId);
    },
  ...
  return (
    <div className="flex h-full w-72 shrink-0 flex-col border-l border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-800">
            {/* "All messages" — always first; deselects any active thread */}
            <button
              ...
              className={`w-full px-4 py-3 text-left transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 ${
                selectedThreadId === null ? 'bg-blue-50 dark:bg-blue-900/20' : ''
              }`}
            >
              ...
              threads.map((thread) => {
                ...
                return (
                  <button
                    ...
                    title={isSelected ? 'Click to deselect topic' : 'Click to view topic'}
                    className={`w-full px-4 py-3 text-left transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 ${
